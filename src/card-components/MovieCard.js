  ...
  render() {
    return (
      <div className="movie-card">
        {[
        <CardFront key={this.props.title+'front'} poster={posterMap[this.props.poster]}/>,
        <CardBack key={this.props.title+'back'} title={this.props.title} IMBDRating={this.props.IMBDRating} genres={this.props.genres} />
        ]}
      </div>
    )
  }
